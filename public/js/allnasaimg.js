...
*/
  ...
  let backgroundimage = urlarr[n];
  console.log("img url", backgroundimage);
  let url = "url("  + backgroundimage + ")";
  $("body").css({height: "940px","background-image" : url});

  $("body").on("dblclick", function() {
    n = Math.floor(Math.random()*max);
    backgroundimage = urlarr[n];
    console.log("img url", backgroundimage);
...
function sequenceDisplayImg(urlarr) {
